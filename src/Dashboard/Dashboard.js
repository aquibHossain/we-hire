...
const Dashboard = () => {
  ...
  const options = admin
    ? ["Home", "Dashboard", "Add Categories", "Make Admin"]
    : ["Home", "Dashboard"];
            ...
            {options.map((text, index) => (
              ...
              >
                ...
                >
                  ...
                  {index == 1 && (
                    <img src="https://img.icons8.com/color/40/000000/dashboard-layout.png" />
                  )}
                  {index == 2 && (
                    <img src="https://img.icons8.com/color/40/000000/add-property.png" />
                  )}
                  {index == 3 && (
                    <img src="https://img.icons8.com/color/40/000000/administrator-male-skin-type-7.png" />
                  )}
                </ListItemIcon>
